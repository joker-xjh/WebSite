	 ...
	 <div id="hotProduct" class="hotProduct clearfix">
    	 ...
    	 <ul class="tab">
            ...
            <c:forEach items = "${hotList }" var = "hot">
            	<li>
                   <a href = "${pageContext.request.contextPath}/findByPid/<c:out value =  "${hot.pid }" />" target="_blank">
                   
                   <img alt="商品" src="${pageContext.request.contextPath }/<c:out value="${hot.image }" />" style="display: block;">
